...
class CustomerWalkThroughScreen extends StatefulWidget {
  @override
  _CustomerWalkThroughScreenState createState() =>
      _CustomerWalkThroughScreenState();
}

class _CustomerWalkThroughScreenState extends State<CustomerWalkThroughScreen> {
  ...
  List<String> details = [
    "Shop from global vendors safely and conveniently.",
    "Pay for your product purchase from any platform of your choice.",
    "Receive your orders right at safely your address.",
  ];
          ...
          children: [
            ...
            Expanded(
              child: PageView(
                ...
                children: <Widget>[
                  _pageBuilder(
                    AvailableImages.customerWalkThroughImg_1["assetPath"]
                        as String,
                    titles[0],
                    details[0],
                  ),
                  _pageBuilder(
                    AvailableImages.customerWalkThroughImg_2["assetPath"]
                        as String,
                    titles[1],
                    details[1],
                  ),
                  _pageBuilder(
                    AvailableImages.customerWalkThroughImg_3["assetPath"]
                        as String,
                    titles[2],
                    details[2],
                  ),
